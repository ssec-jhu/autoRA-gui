...
// Generated with 33 components from 3 categories
...
export const EMBEDDED_COMPONENTS = {
  "experimentalists": [
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-grid",
      "pipVersion": "1.0.0",
      "parameters": [],
      "inputDataType": [
        {
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-inequality",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-lhs",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-leverage",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
    ...
    },
    {
      ...
      "pipInstall": "experimentalist-sampler-mixture",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "temperature",
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-model-disagreement",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-nearest_value",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-novelty",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-prediction-filter",
      "pipVersion": "1.0.0",
      "parameters": [
        {
    ...
    },
    {
      ...
      "pipInstall": "autora-experimentalist-uncertainty",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "num_samples",
  ...
  "theorists": [
    ...
    },
    {
      ...
      "pipInstall": "autora-theorist-bsr",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "tree_num",
    ...
    },
    {
      ...
      "pipInstall": "autora-theorist-darts",
      "pipVersion": "1.1.0",
      "parameters": [
        {
          "name": "batch_size",
  ...
  "experiment_runners": [
    {
      ...
      "githubCommit": "https://github.com/AutoResearch/autora-experiment-runner-firebase-prolific/blob/main/src/autora/experiment_runner/firebase_prolific/__init__.py#L153",
    ...
    },
    {
      ...
      "githubCommit": "https://github.com/AutoResearch/autora-experiment-runner-firebase-prolific/blob/main/src/autora/experiment_runner/firebase_prolific/__init__.py#L176",
    ...
    },
    {
      ...
      "pipInstall": "autora-synthetic-abstract-equation",
      "pipVersion": "1.0.0",
      "parameters": [
        {
          "name": "expression",
    ...
    {
      "uuid": "da749212-4643-4f86-89b3-69ea4a90e49a",
      "protocolType": "experiment_runner",
      "name": "Template Experiment (Synthetic, Abstract)",
      "description": "A template for creating synthetic experiments. Serves as a blueprint demonstrating how to structure experiments with configurable parameters, variable definitions, simulation functions with noise capability, and visualization tools.",
      "githubCommit": "https://github.com/AutoResearch/autora-synthetic/blob/main/src/autora/experiment_runner/synthetic/abstract/template_experiment.py#L74",
      "pythonName": "template_experiment",
      "importPath": "autora.experiment_runner.synthetic.abstract.template_experiment",
      "pipInstall": "autora-synthetic",
      "pipVersion": "1.0.0",
      "parameters": [],
      "inputDataType": [
      ...
      "outputDataType": [
        {
          "name": "observations",
          "description": "Simulated dependent variable values from the template experiment.",
          "datatype": "real",
          "cardinality": {
            "minOccurs": 1,
            "maxOccurs": -1,
      ...
      "file": "synth_abstr_template_experiment.json"
    },
    {
