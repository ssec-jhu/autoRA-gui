...
// Generated with 39 components from 3 categories

export const EMBEDDED_COMPONENTS = {
  "experimentalists": [
    {
      "uuid": "e8eb1ee0-7bf7-47f1-833a-54b471edd252",
      "protocolType": "experimentalist",
      "name": "Adaptable Sampler",
      "description": "adaptive experimentalist that samples from a set of samplers based on its history of surprisal (as jensen shannon divergence)",
      "githubCommit": "https://github.com/MoAljam/autora-experimentalist-challenge-g-1/blob/4e96fcc4fe8b5ca24a3bd507d566f99199ba9ab9/src/autora/experimentalist/adaptable/__init__.py#L402",
      "pythonName": "sample",
      "importPath": "autora.experimentalist.adaptable",
      "pipInstall": "autora-adaptable-experimentalist",
      "parameters": {
        "sample": [
          {
            "name": "samplers",
            "description": "list of dicts each sampler is a dictionary with the following keys: - func: callable sampler - params: dict - name: str sampler_coords: list of the locations of the samplers on arbitrary 1d-scale",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "meta_score_func",
            "description": "callable, function to calculate the meta score",
            "datatype": "string",
            "cardinality": {
              "minOccurs": 0,
              "maxOccurs": 1,
          ...
          {
            "name": "sensitivity",
            "description": "float, int, scaler for the exponential bias higher number maps to more sensitivity of changes in the meta score (surprisal , jsd)",
            "datatype": "integer",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "temperature",
            "description": "float, int, scaler for the std of the gaussian distribution around the mapping int the sampling space",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "plot_info",
            "description": "bool, plot the distributions",
            "datatype": "boolean",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
      ...
      "inputDataType": {
        "variables": [
          {
            "name": "conditions",
            "description": "conditions to sample from",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": -1,
      ...
      "outputDataType": {
        "name": "conditions",
        "description": "pd.DataFrame: new conditions with a score column",
        "datatype": "real",
        "cardinality": {
          "minOccurs": 1,
          "maxOccurs": -1,
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/bandit-random/",
      "pythonName": "pool",
    ...
    {
      "uuid": "15530705-aa4e-445a-9c9f-1c51c5b1575b",
      "protocolType": "experimentalist",
      "name": "Confirmation Pooler",
      "description": "A pooler that generates samples for independent variables with the objective of maximizing the (approximated) loss of the model. The samples are generated by first training a neural network to approximate the loss of a model for all patterns in the training data. Once trained, the network is then inverted to generate samples that maximize the approximated loss of the model.",
      "githubCommit": "https://github.com/MoAljam/autora-experimentalist-challenge-g-1/blob/4e96fcc4fe8b5ca24a3bd507d566f99199ba9ab9/src/autora/experimentalist/confirmation/__init__.py#L22",
      "pythonName": "pool",
      "importPath": "autora.experimentalist.confirmation",
      "pipInstall": "autora-adaptable-experimentalist",
      "parameters": {
        "pool": [
          {
            "name": "metadata",
            "description": "Meta-data about the dependent and independent variables",
            "datatype": "string",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          },
          {
            ...
            "description": "number of epochs to train the popper network for approximating the error fo the model",
            "datatype": "integer",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          },
          {
            ...
            "description": "number of epochs to optimize the samples based on the trained popper network",
            "datatype": "integer",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          },
          {
            ...
            "description": "learning rate for optimizing the samples",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "limit_offset",
            "description": "a limited offset to prevent the samples from being too close to the value boundaries",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          },
          {
            ...
            "description": "a limited repulsion to prevent the samples from being too close to the allowed value boundaries",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "plot",
            "description": "print out the prediction of the popper network as well as its training loss",
            "datatype": "boolean",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
      ...
      "inputDataType": {
        "variables": [
          {
            "name": "model",
            "description": "Scikit-learn model, could be either a classification or regression model",
            "datatype": "string",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "reference_conditions",
            "description": "data that the model was trained on",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": -1,
          ...
          },
          {
            ...
            "description": "labels that the model was trained on",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": -1,
      ...
      "file": "confirmation_pooler.json"
    },
    {
      "uuid": "f7674d23-022b-43c8-9f72-d9f02ac24f5f",
      "protocolType": "experimentalist",
      "name": "Confirmation Sampler",
      "description": "A Sampler that generates samples of experimental conditions with the objective of maximizing the (approximated) loss of a model relating experimental conditions to observations. The samples are generated by first training a neural network to approximate the loss of a model for all patterns in the training data. Once trained, the network is then provided with the candidate samples of experimental conditions and the selects those with the highest loss.",
      "githubCommit": "https://github.com/MoAljam/autora-experimentalist-challenge-g-1/blob/4e96fcc4fe8b5ca24a3bd507d566f99199ba9ab9/src/autora/experimentalist/confirmation/__init__.py#L184",
      "pythonName": "sample",
      "importPath": "autora.experimentalist.confirmation",
      "pipInstall": "autora-adaptable-experimentalist",
      "parameters": {
        "sample": [
          {
            "name": "metadata",
            "description": "Meta-data about the dependent and independent variables specifying the experimental conditions",
            "datatype": "string",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
          ...
          {
            "name": "training_epochs",
            "description": "Number of epochs to train the popper network for approximating the error of the model",
            "datatype": "integer",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": 1,
      ...
      "inputDataType": {
        "variables": [
          {
            "name": "conditions",
            "description": "The candidate samples of experimental conditions to be evaluated.",
            "datatype": "real",
            "cardinality": {
              "minOccurs": 1,
              "maxOccurs": -1,
      ...
      "outputDataType": {
        "name": "conditions",
        "description": "Samples with the highest loss",
        "datatype": "real",
        "cardinality": {
          "minOccurs": 1,
          "maxOccurs": -1,
      ...
      "file": "confirmation_sampler.json"
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/falsification/",
      "pythonName": "pool",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/core/docs/experimentalists/grid/",
      "pythonName": "pool",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/leverage/",
      "pythonName": "sample",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/mixture/",
      "pythonName": "sample",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/model-disagreement/",
      "pythonName": "sample",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/nearest-value/",
      "pythonName": "sample",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/novelty/",
      "pythonName": "sample",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/novelty/Basic%20Usage/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/prediction-filter/",
      "pythonName": "filter",
    ...
    {
      "uuid": "68dc9565-3cd2-4374-b0e2-9eccabbf574a",
      "protocolType": "experimentalist",
      "name": "Progressive Sampler",
      "description": "Sample from a list of samplers based on the progress / assumed confidence of model in the sampling process.",
      "githubCommit": "https://github.com/MoAljam/autora-experimentalist-challenge-g-1/blob/4e96fcc4fe8b5ca24a3bd507d566f99199ba9ab9/src/autora/experimentalist/progressive/__init__.py#L140",
      "pythonName": "sample",
      "importPath": "autora.experimentalist.progressive",
      "pipInstall": "autora-adaptable-experimentalist",
      "parameters": {
        "sample": [
          {
      ...
      "outputDataType": {
        "name": "conditions",
        "description": "pd.DataFrame: new conditions",
        "datatype": "real",
        "cardinality": {
          "minOccurs": 1,
          "maxOccurs": -1,
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/core/docs/experimentalists/random/",
      "pythonName": "pool",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/core/docs/pipeline/Experimentalist%20Pipeline%20Examples/",
      "pythonName": "sample",
      "importPath": "autora.experimentalist.random",
      "pipInstall": "autora-core==5.0.3",
      "parameters": {
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/inequality/",
      "pythonName": "sample",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experimentalists/uncertainty/",
      "pythonName": "sample",
  ...
  "theorists": [
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/theorists/bms/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/theorists/bsr/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/theorists/darts/",
  ...
  "experiment_runners": [
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/user-guide/experiment-runners/behavioral-web-experiments/firebase-prolific-runner/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/reference/autora/experiment_runner/firebase_prolific/#autora.experiment_runner.firebase_prolific.firebase_runner",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Abstract/LMM/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Economics/Expected-Value-Theory/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Economics/Prospect-Theory/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Neuroscience/Task-Switching/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Psychology/Exponential-Learning/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Psychology/Luce-Choice-Ratio/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Psychology/Q-Learning/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/reference/autora/experiment_runner/synthetic/psychophysics/stevens_power_law/",
    ...
    },
    {
      ...
      "github_io": "https://autoresearch.github.io/autora/synthetic/docs/Examples/Psychophysics/Weber-Fechner-Law/",
