/**
 * Component Palette Module (Standalone)
 * Uses embedded component data instead of API calls.
 */

import { state } from './state.js';
import { updateStatus, getTypeIcon, formatTypeName } from './utils.js';
import { handleDragStart, handleDragEnd } from './dragDrop.js';
import { EMBEDDED_COMPONENTS } from './components.data.js';

/**
 * Load components from embedded data and render palette
 */
export function loadComponentsStandalone() {
