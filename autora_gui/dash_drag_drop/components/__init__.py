...
class BaseComponent:
    ...
    def execute(self, input_data: float = None) -> int | float:
...
def get_component_definitions() -> list[dict[str, str]]:
    ...
    return [
        {"type": "number", "title": "Number (5)", "description": "Outputs the number 5", "icon": "5️⃣"},
        {"type": "add", "title": "Add (+3)", "description": "Adds 3 to the input", "icon": "➕"},
        {"type": "multiply", "title": "Multiply (×2)", "description": "Multiplies input by 2", "icon": "✖️"},
        {"type": "subtract", "title": "Subtract (-1)", "description": "Subtracts 1 from input", "icon": "➖"},
        {"type": "square", "title": "Square (x²)", "description": "Squares the input", "icon": "²"},
    ]
